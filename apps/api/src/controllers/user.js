...
var getUsers = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                users = _a.sent();
                (0, responseUtils_1.sendSuccess)({ res: res, datas: users });
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
...
var updateUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, user_1.User.findByIdAndUpdate(req.params.id, req.body, {
                        "new": true
                    })];
            case 1:
                user = _a.sent();
...
var deleteUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, user_1.User.findByIdAndDelete(req.params.id)];
            case 1:
                _a.sent();
                res.status(204).send();
                return [3 /*break*/, 3];
